                ...
                {user && (
                    <>
                        <div className="flex flex-col text-right hidden sm:block">
                            <span className="text-sm font-medium text-gray-900">{user.realName || user.username}</span>
                            <span className="text-xs text-gray-500 capitalize">{user.role} - {user.status || 'Offline'}</span>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 font-bold overflow-hidden">
                                {user.profilePicture ? (
                                    ...
                                    (user.realName || user.username || 'U')[0].toUpperCase()
                                )}
                            </div>
                        </div>
